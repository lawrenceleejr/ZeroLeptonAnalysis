...
#include all these
        ...
        if not options.isTest :
            RJigsawVariables = {
            "HT1CM"                                            :  [100, 0 , 1000, True],
            "PIoHT1CM"                                         :  [100, -1 , 1, False ],
            "cosS"                                             :  [100, -1 , 1, False ],
            "NVS"                                              :  [100, -1 , 1, False ],
            "RPT_HT1CM"                                        :  [100, -1 , 1, False ],
            "MS"                                               :  [100, -1 , 1, False ],
            "ddphiP"                                           :  [100, -1 , 1, False ],
            "sdphiP"                                           :  [100, -1 , 1, False ],
            "pPP_Ia"                                           :  [100, 0 , 1000, True],
            "pPP_Ib"                                           :  [100, 0 , 1000, True ],
            "pT_jet1a"                                         :  [100, 0 , 1000, True],
            "pT_jet1b"                                         :  [100, 0 , 1000, False ],
            "pT_jet2a"                                         :  [100, 0 , 1000,False],
            "pT_jet2b"                                         :  [100, 0 , 1000,False],
            "pTPP_jet1"                                         :  [100, 0 , 1000, True ],
            "pTPP_jet2"                                         :  [100, 0 , 1000, True ],
            "pTPP_jet1a"                                        :  [100, 0 , 1000, True ],
            "pTPP_jet1b"                                        :  [100, 0 , 1000, True ],
            "pTPP_jet2a"                                       :  [100, 0 , 1000, True ],
            "pTPP_jet2b"                                       :  [100, 0 , 1000, True ],
            "pTPP_jet3a"                                       :  [100, 0 , 1000, True ],
            "pTPP_jet3b"                                      :  [100, 0 , 1000, True ],
            "pPP_jet1a"                                       :  [100, 0 , 1000, False],
            "pPP_jet1b"                                       :  [100, 0 , 1000, False],
            "pPP_jet2a"                                             :  [100, 0 , 1000, True],
            "pPP_jet2b"                                        :  [100, 0 , 1000, True ],
            "pPP_jet3a"                                        :  [100, 0 , 1000, True ],
            "pPP_jet3b"                                         :  [100, 0 , 1000, True ],
            "R_H2PP_H3PP"                                       :  [100, -1 , 1, False ],
            "R_pTj2_HT3PP"                                     :  [100, -1 , 1, False ],
            "R_HT5PP_H5PP"                                      :  [100, -1 , 1, False ],
            "R_H2PP_H5PP"             :  [100, -1 , 1, False],
            "minR_pTj2i_HT3PPi"       :  [100, -1 , 1, False],
            "maxR_H1PPi_H2PPi"        :  [100, 0 , 4000, True],
            "R_HT9PP_H9PP"            :  [100, -1 , 1, False],
            "R_H2PP_H9PP"             :  [100, -1 , 1, False],
            "RPZ_HT3PP"               :  [100, -1 , 1, False],
            "RPZ_HT5PP"               :  [100, -1 , 1, False],
            "RPZ_HT9PP"               :  [100, -1 , 1, False],
            "RPT_HT3PP"               :  [100, -1 , 1, False],
            "RPT_HT5PP"               :  [100, -1 , 1, False],
            "RPT_HT9PP"               :  [100, -1 , 1, False],
            "PP_InvGamma"             :  [100, 0 , 1000, True],
            "PP_dPhiBetaR"            :  [100, -1 , 1, False],
            "PP_dPhiVis"              :  [100, -1 , 1, False],
            "PP_CosTheta"             :  [100, -1 , 1, False],
            "PP_dPhiDecayAngle"       :  [100, -1 , 1, False],
            "PP_VisShape"             :  [100, 0 , 1000, True],
            "PP_MDeltaR"              :  [100, 0 , 1000, True],
            "P1_Mass"                 :  [100, 0 , 1000, True],
            "P1_CosTheta"             :  [100, -1 , 1, False],
            "P2_Mass"                 :  [100, 0 , 1000, False ],
            "P2_CosTheta"             :  [100, -1 , 1, False ],
            "I1_Depth"                :  [100, 0 , 10, False ],
            "I2_Depth"                :  [100, 0 , 10, True],
            "dphiPV1a"                :  [100, -1 , 1, False],
            "cosV1a"                  :  [100, -1 , 1, False ],
            "dphiCV2a"                            :  [100, -1 , 1, False],
            ...
            "NJa"                                 :  [100, -1 , 1, False ],
            "NJb"                                 :  [100, 0 , 10, False ],
            "dphiVG"                              :  [100, 0 , 10, False ],
            "QCD_dPhiR"                           :  [100, -1 , 1, False ],
            "QCD_Rsib"                            :  [100, -1 , 1, False ],
            "QCD_Delta1"                          :  [100, -1 , 1, False ],
            "H2PP"                                 :  [100, 0 , 1000,False],
            "H3PP"                                 :  [100, 0 , 1000,False],
            "H4PP"                                 :  [100, 0 , 1000, True ],
            "H6PP"                                 :  [100, 0 , 1000, True ],
            "H10PP"                                :  [100, 0 , 1000, True ],
            "HT10PP"                               :  [100, 0 , 1000, True ],
            "H2Pa"                                :  [100, 0 , 1000, True ],
            "H2Pb"                                :  [100, 0 , 1000, True ],
            "H3Pa"                                :  [100, 0 , 1000, True ],
            "H3Pb"                                :  [100, 0 , 1000, True ],
            "H4Pa"                                :  [100, 0 , 1000, True],
            "H4Pb"                                :  [100, 0 , 1000, True],
            "H5Pa"                                :  [100, 0 , 1000, True],
            "H5Pb"                                :  [100, 0 , 1000, True ],
            "H2Ca"                                :  [100, 0 , 1000, True ],
            "H2Cb"                                 :  [100, 0 , 1000, True ],
            "H3Ca"                                 :  [100, 0 , 1000, True ],
            "H3Cb"                                :  [100, 0 , 1000, True ],
            "HT4PP"                                :  [100, 0 , 1000, True ],
            "HT6PP"                               :  [100, 0 , 1000, True],
            "sangle"                              :  [100, -1 , 1, False],
