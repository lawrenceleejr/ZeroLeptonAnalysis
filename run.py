...
for SH_name, mysamplehandler in my_SHs.iteritems():
	...
	if os.path.exists( "/afs/cern.ch/work/r/rsmith/outputCorrelationPlots/output/"+SH_name ):
		shutil.rmtree( "/afs/cern.ch/work/r/rsmith/outputCorrelationPlots/output/"+SH_name )
	driver.submitOnly(job, "/afs/cern.ch/work/r/rsmith/outputCorrelationPlots/output/"+SH_name )
