...
%
\begin{document}
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{summaryMU}\end{tabular}\end{center}\end{figure}
\clearpage
\include{yield_SR2jTest}
\include{yield_SR4jTest}
\clearpage
\include{systtable_SR2jTest}
\include{systtable_SR4jTest}
\clearpage
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{histpull_SR2jTest}\end{tabular}\end{center}\end{figure}
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{histpull_SR4jTest}\end{tabular}\end{center}\end{figure}
\clearpage
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{MU_SR2jTest}\end{tabular}\end{center}\end{figure}
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{MU_SR4jTest}\end{tabular}\end{center}\end{figure}
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{summaryNP}\end{tabular}\end{center}\end{figure}
\clearpage
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{NP_SR2jTest}\end{tabular}\end{center}\end{figure}
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{NP_SR4jTest}\end{tabular}\end{center}\end{figure}
\clearpage
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{corr_SR2jTest}\end{tabular}\end{center}\end{figure}
\begin{figure}[h]\begin{center}\begin{tabular}{cc}\includegraphics[width=1\textwidth]{corr_SR4jTest}\end{tabular}\end{center}\end{figure}
