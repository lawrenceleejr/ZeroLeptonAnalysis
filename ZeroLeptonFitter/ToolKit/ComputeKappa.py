...
if NFittedZInVRZ!=NMCZInVRZ:
    ...
    print "WARNING!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    print "WARNING!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    print "The number of fitted and predicted are not the same for Z+jets are the same"
...
if NMCGammaInCRY!=NFittedGammaInCRY:
    ...
    print "WARNING!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    print "WARNING!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    print "The number of fitted and predicted are not the same for gamma+jets are the same"
    print "This is suspicious!!!!"
...
print "Nb of bkg events in CRY:",NBkgInCRY
print "Nb of bkg events in VRZ:",NBkgInVRZ
