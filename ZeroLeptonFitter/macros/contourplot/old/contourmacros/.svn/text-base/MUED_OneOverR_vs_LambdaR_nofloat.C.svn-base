...
const char* MUED_OneOverR_vs_LambdaR_nofloat(const char* textfile = 0, TH2D* inputHist = 0, const char* rootfile = "mgluinomlsp_nofloat.root", TString id1="mgluino",TString id2="mlsp", int   nbinsX=40,int nbinsY=40, float minX=600,float maxX=1500, float minY=0, float maxY=40)
{
   ...
   TString correlation="LambdaR:oneOverR";
