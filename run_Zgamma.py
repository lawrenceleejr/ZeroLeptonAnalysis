...
#    print cry_cuts
    ...
    if options.isTest :
        ...
        RJigsawVariables = {
            "HT1CM"                  :  [25, 0 , 5000, True],
            "PIoHT1CM"               :  [25, 0 , 1, False ],
            "cosS"                   :  [25, -1 , 1, False ],
            "NVS"                    :  [10,  0 , 10, False ],
            "RPT_HT1CM"              :  [25, 0 , 1, False ],
            "MS"                     :  [25,  0, 5000, True ],
            "ddphiP"                 :  [25, -1 , 1, False ],
            "sdphiP"                 :  [25, 0 , 1, False ],
            ...
            "R_H2PP_H3PP"            :  [25, 0 , 1, False ],
            "R_pTj2_HT3PP"           :  [25, 0 , 1, False ],
            "R_HT5PP_H5PP"           :  [25, 0 , 1, False ],
            "R_H2PP_H5PP"            :  [25, 0 , 1, False],
            "minR_pTj2i_HT3PPi"      :  [25, 0 , 1, False],
            "maxR_H1PPi_H2PPi"       :  [25, 0 , 1, False],
            "R_HT9PP_H9PP"           :  [25, 0 , 1, False],
            "R_H2PP_H9PP"            :  [25, 0 , 1, False],
            "RPZ_HT3PP"              :  [25, 0 , 1, False],
            "RPZ_HT5PP"              :  [25, 0 , 1, False],
            "RPZ_HT9PP"              :  [25, 0 , 1, False],
            ...
            # "NJa"                    :  [10, 0 , 10, False ],
            # "NJb"                    :  [10, 0 , 10, False ],
            "QCD_dPhiR"              :  [25, -1 , 1, False ], # always -100
            "QCD_Rsib"               :  [25, 0 , 1, False ],
            "QCD_Delta1"             :  [25, -1 , 1, False ],
            "H2PP"                   :  [25, 0 , 5000, True ],
            "H3PP"                   :  [25, 0 , 5000, True ],
            "H4PP"                   :  [25, 0 , 5000, True ],
            "H6PP"                   :  [25, 0 , 5000, True ],
    ...
    if options.isTest:
        ...
        NTVariables = {
            ...
            "bosonEt"                    :  [25, 0 , 1000, True, "sqrt(NTExtraVars.ZvvPt**2+max(NTExtraVars.ZvvM,120e3)**2)" if bosonType=="z" else "NTCRYVars.phPt"],
            "dPhi"                       :  [32,  0 , 3.2, False],
            #            "Nj50" :  [10,  0 , 10,   False, "Sum$(jetPt>50)"],
            #            "HT50" :  [25, 0 , 5000, False, "Sum$(jetPt*(jetPt>50))"],
            }
