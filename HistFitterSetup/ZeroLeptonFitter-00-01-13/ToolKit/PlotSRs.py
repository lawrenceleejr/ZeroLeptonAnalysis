...
samples=  ["Diboson","Zjets","Top","Wjets","Multijets"]#"GAMMAjets"
...
#    leg1.AddEntry(hist_data,"Data 2012 (#sqrt{s}=8TeV)","P")
    ...
    for sam in reversed(samples):
        leg1.AddEntry(hist_bkgMap[sam],sam.replace("Wjets","W+jets").replace("Zjets","Z+jets").replace("Top","t#bar{t}(+EW) & single top"),"F")
    leg1.Draw()
