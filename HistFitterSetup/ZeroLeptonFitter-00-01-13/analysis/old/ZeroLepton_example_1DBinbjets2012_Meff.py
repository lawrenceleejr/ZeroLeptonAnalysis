################################################################
##
## 2012 Meff binned 0-lepton analysis with bjets
## 
## Usage: HistFitter.py -p -t -w -d -f -r "SRE,tight" --exclfit -g "900_2500_100" analysis/ZeroLepton_example_1DBinbjets2012_Meff.py
## 
################################################################
...
grid="Gtt"              # only grid implemented up to now
allpoints=["900_2500_100"]  #msugra points given as M0_M12
anaName="test"          #
...
# Signal regions
configMgr.cutsDict["SR"]    = baselineSR[chn]+" && "+dphicut[chn]+" && "+metomeffcut[chn]+" && "+meffcut+" && "+bjetcut

# Control regions
configMgr.cutsDict["CRW"]   = baselineSR[chn]+" && "+meffcut+" && "+bjetveto

configMgr.cutsDict["CRT"] = baselineSR[chn]+" && "+meffcut+" && "+bjetcut
configMgr.cutsDict["CR1a"]  = baselineSR[chn]+" && "+dphicut[chn]+" && "+metomeffcut[chn]+" && "+meffcut+"  &&  "+photonSelection+" && "+bjetcut
...
configMgr.cutsDict["VRZ"]   = baselineSR[chn]+" && "+meffcut+" && "+bjetcut 
