...
regionDict["CRW"] = Region("CRW", "CRWT", ["(lep1Triggered & 0x03)!=0  &&  nBJet==0 && lep1Pt>27"], ["btagSystWeight[0]"])
regionDict["CRT"] = Region("CRT", "CRWT", ["(lep1Triggered & 0x03)!=0  &&  nBJet>0  && lep1Pt>27"], ["btagSystWeight[0]"])
# regionDict["CRT"] = Region("CRT", "SRAll", ["nBJet>0"], ["btagSystWeight
#regionDict["CRTZL"] = Region("CRTZL", "SRAll", ["nBJet>0",cleaningCut], [0]"])
regionDict["CRWT"] = Region("CRWT", "CRWT", ["lep1Triggered & 0x03)!=0 &&  nBJet>=0 && lep1Pt>27"], ["btagSystWeight[0]"])
...
regionDict["VRW"] = Region ("VRW",  "CRWT", ["lep1Triggered & 0x03)!=0 &&  nBJet==0 && lep1Pt>27"], ["btagSystWeight[0]"])
regionDict["VRWa"] = Region("VRWa", "CRWT", ["lep1Triggered & 0x03)!=0 &&  nBJet==0 && lep1Pt>27"], ["btagSystWeight[0]"])
regionDict["VRWb"] = Region("VRWb", "CRWT", ["lep1Triggered & 0x03)!=0 &&  nBJet==0 && lep1Pt>27"], ["btagSystWeight[0]"])
#regionDict["CRWL"] = Region("VRWL", "CRWT", ["nBJet==0"], ["btagSystWeigh
#regionDict["CRWVL"] = Region("VRWVL", "CRWT", ["nBJet==0"], ["btagSystWei
regionDict["VRT"] = Region("VRT", "CRWT",   ["(lep1Triggered & 0x03)!=0 && nBJet>0  && lep1Pt>27"], ["btagSystWeight[0]"])
regionDict["VRTa"] = Region("VRTa", "CRWT", ["(lep1Triggered & 0x03)!=0 && nBJet>0  && lep1Pt>27"], ["btagSystWeight[0]"])
regionDict["VRTb"] = Region("VRTb", "CRWT", ["(lep1Triggered & 0x03)!=0 && nBJet>0  && lep1Pt>27"], ["btagSystWeight[0]"])
