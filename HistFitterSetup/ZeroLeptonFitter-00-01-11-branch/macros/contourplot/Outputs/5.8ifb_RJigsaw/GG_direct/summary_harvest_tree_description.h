...
void writetree() {
  ...
  TFile* file = TFile::Open("/imports/rcs5_data/larryl/ZeroLeptonAnalysis/HistFitterSetup/ZeroLeptonFitter-00-01-11-branch/macros/contourplot/Outputs/5.8ifb_RJigsaw/GG_direct/GG_direct_SRJigsawSRG1a_fixSigXSecNominal__1_harvest_list.root","RECREATE");
  file->cd();
  tree->Write();
  file->Close();
}
