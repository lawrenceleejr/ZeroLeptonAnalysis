...
TTree* harvesttree(const char* textfile=0) {
  const char* filename    = "/data/data1/zp/shadachi/analysis/HistFitter/ZeroLeptonFitter/00-01-11-08_2/ZeroLeptonFitter/macros/contourplot/Outputs/3.2ifb/GG_direct/GG_direct_SR6jt_fixSigXSecDown__1_harvest_list";
...
void writetree() {
  ...
  TFile* file = TFile::Open("/data/data1/zp/shadachi/analysis/HistFitter/ZeroLeptonFitter/00-01-11-08_2/ZeroLeptonFitter/macros/contourplot/Outputs/3.2ifb/GG_direct/GG_direct_SR6jt_fixSigXSecDown__1_harvest_list.root","RECREATE");
  file->cd();
  tree->Write();
  file->Close();
}
