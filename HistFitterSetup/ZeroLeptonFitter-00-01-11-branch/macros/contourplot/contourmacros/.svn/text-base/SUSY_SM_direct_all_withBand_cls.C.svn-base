...
void SUSY_SM_direct_all_withBand_cls( TString fname0="", TString fname1="",
        TString fname2="",
        TString gridname="",
        ...
        TString fname_xsec4 = "",
        TString fname_xsec8 = "",        
        TString fname_xsec2_up = "",
        TString fname_xsec4_up = "",
        TString fname_xsec8_up = "",        
        TString fname_xsec2_down = "",
        TString fname_xsec4_down = "",
        TString fname_xsec8_down = "",        
        int channel = -1,
        ...
        TString fnameMass= "contourmacros/mSugraGridtanbeta10_gluinoSquarkMasses.root")
{
    ...
    if(fname_xsec2_up != TString("") ) {
        fxsec2_up = TFile::Open( fname_xsec2_up, "READ" );
        if(!fxsec2_up) cout << "Warning: could not open " << fname_xsec2_up << endl;
    }
    if(fname_xsec2_down != TString("") ) {
        fxsec2_down = TFile::Open( fname_xsec2_down, "READ" );
        if(!fxsec2_down) cout << "Warning: could not open " << fname_xsec2_down << endl;
    }
    ...
    if(fname_xsec4_up != TString("") ) {
        fxsec4_up = TFile::Open( fname_xsec4_up, "READ" );
        if(!fxsec4_up) cout << "Warning: could not open " << fname_xsec4_up << endl;
    }
    if(fname_xsec4_down != TString("") ) {
        fxsec4_down = TFile::Open( fname_xsec4_down, "READ" );
        if(!fxsec4_down) cout << "Warning: could not open " << fname_xsec4_down << endl;
    }
    ...
    if(fname_xsec8_up != TString("") ) {
        fxsec8_up = TFile::Open( fname_xsec8_up, "READ" );
        if(!fxsec8_up) cout << "Warning: could not open " << fname_xsec8_up << endl;
    }
    if(fname_xsec8_down != TString("") ) {
        fxsec8_down = TFile::Open( fname_xsec8_down, "READ" );
        if(!fxsec8_down) cout << "Warning: could not open " << fname_xsec8_down << endl;
    }
    ...
    TH2F* histe_esigxsp1s_xsec2;
    if (fname_xsec2_up != "" && fxsec2_up)  {
        histe_esigxsp1s_xsec2 = (TH2F*)fxsec2_up->Get( hname0 );
        cout << "Read up/2 histogram " << histe_esigxsp1s_xsec2 << endl;
    }
    
    TH2F* histe_esigxsp1s_xsec4;
    if (fname_xsec4_up != "" && fxsec4_up)  {
        histe_esigxsp1s_xsec4 = (TH2F*)fxsec4_up->Get( hname0 );
        cout << "Read up/4 histogram " << histe_esigxsp1s_xsec4 << endl;
    }
    
    TH2F* histe_esigxsp1s_xsec8;
    if (fname_xsec8_up != "" && fxsec8_up)  {
        histe_esigxsp1s_xsec8 = (TH2F*)fxsec8_up->Get( hname0 );
        cout << "Read up/8 histogram " << histe_esigxsp1s_xsec8 << endl;
    }
    ...
    TH2F* histe_esigxsm1s_xsec2;
    if (fname_xsec2_down != "" && fxsec2_down) { 
        histe_esigxsm1s_xsec2 = (TH2F*)fxsec2_down->Get( hname0 ); 
        cout << "Read down/2 histogram " << histe_esigxsm1s_xsec2 << endl;
    }
    
    TH2F* histe_esigxsm1s_xsec4;
    if (fname_xsec4_down != "" && fxsec4_down) { 
        histe_esigxsm1s_xsec4 = (TH2F*)fxsec4_down->Get( hname0 ); 
        cout << "Read down/4 histogram " << histe_esigxsm1s_xsec4 << endl;
    }
    
    TH2F* histe_esigxsm1s_xsec8;
    if (fname_xsec8_down != "" && fxsec8_down) { 
        histe_esigxsm1s_xsec8 = (TH2F*)fxsec8_down->Get( hname0 ); 
        cout << "Read down/8 histogram " << histe_esigxsm1s_xsec8 << endl;
    }
    ...
    if (fname_xsec2 != "" && fxsec2) {
        ...
        histocls_xsec2 = (TH2F*)fxsec2->Get( "sigp1clsf" );
    ...
    if (fname_xsec4 != "" && fxsec4) {
        ...
        histocls_xsec4 = (TH2F*)fxsec4->Get( "sigp1clsf" );
    ...
    if (fname_xsec8 != "" && fxsec8) {
        ...
        histocls_xsec8 = (TH2F*)fxsec8->Get( "sigp1clsf" );
    ...
    if (histe_esigxsp1s_xsec2!=0) histe_esigxsp1s_xsec2->SetDirectory(0);
    if (histe_esigxsm1s_xsec2!=0) histe_esigxsm1s_xsec2->SetDirectory(0);
    if (histe_esigxsp1s_xsec4!=0) histe_esigxsp1s_xsec4->SetDirectory(0);
    if (histe_esigxsm1s_xsec4!=0) histe_esigxsm1s_xsec4->SetDirectory(0);
    if (histe_esigxsp1s_xsec8!=0) histe_esigxsp1s_xsec8->SetDirectory(0);
    if (histe_esigxsm1s_xsec8!=0) histe_esigxsm1s_xsec8->SetDirectory(0);
    ...
    TH2F* contour_esigxsp1s_xsec2
        = ( histe_esigxsp1s_xsec2!=0 ? FixAndSetBorders( *histe_esigxsp1s_xsec2, "contour_esigxsp1s_xsec2", "contour_esigxsp1s_xsec2", 0 ) : 0);
    TH2F* contour_esigxsm1s_xsec2
        = ( histe_esigxsm1s_xsec2!=0 ? FixAndSetBorders( *histe_esigxsm1s_xsec2, "contour_esigxsm1s_xsec2", "contour_esigxsm1s_xsec2", 0 ) : 0);
    TH2F* contour_esigxsp1s_xsec4
        = ( histe_esigxsp1s_xsec4!=0 ? FixAndSetBorders( *histe_esigxsp1s_xsec4, "contour_esigxsp1s_xsec4", "contour_esigxsp1s_xsec4", 0 ) : 0);
    TH2F* contour_esigxsm1s_xsec4
        = ( histe_esigxsm1s_xsec4!=0 ? FixAndSetBorders( *histe_esigxsm1s_xsec4, "contour_esigxsm1s_xsec4", "contour_esigxsm1s_xsec4", 0 ) : 0);
    TH2F* contour_esigxsp1s_xsec8
        = ( histe_esigxsp1s_xsec8!=0 ? FixAndSetBorders( *histe_esigxsp1s_xsec8, "contour_esigxsp1s_xsec8", "contour_esigxsp1s_xsec8", 0 ) : 0);
    TH2F* contour_esigxsm1s_xsec8
        = ( histe_esigxsm1s_xsec8!=0 ? FixAndSetBorders( *histe_esigxsm1s_xsec8, "contour_esigxsm1s_xsec8", "contour_esigxsm1s_xsec8", 0 ) : 0);
    ...
    TH2F* hist5_xsec2;
    if(fxsec2){
        hist3_xsec2 = (TH2F*)fxsec2->Get( hname3 );
        hist5_xsec2 = (TH2F*)fxsec2->Get( hname5 );

        if(hist3_xsec2) hist3_xsec2->SetDirectory(0);
        if(hist5_xsec2) hist5_xsec2->SetDirectory(0);
    }
    
    TH2F* hist3_xsec4; 
    TH2F* hist5_xsec4;
    if(fxsec4){
        hist3_xsec4 = (TH2F*)fxsec4->Get( hname3 );
        hist5_xsec4 = (TH2F*)fxsec4->Get( hname5 );

        if(hist3_xsec4) hist3_xsec4->SetDirectory(0);
        if(hist5_xsec4) hist5_xsec4->SetDirectory(0);
    }
    
    TH2F* hist3_xsec8; 
    TH2F* hist5_xsec8;
    if(fxsec8){
        hist3_xsec8 = (TH2F*)fxsec8->Get( hname3 );
        hist5_xsec8 = (TH2F*)fxsec8->Get( hname5 );

        if(hist3_xsec8) hist3_xsec8->SetDirectory(0);
        if(hist5_xsec8) hist5_xsec8->SetDirectory(0);
    }
    ...
    TH2F* contour_ep1s_xsec2    = ( hist3_xsec2!=0 ? FixAndSetBorders( *hist3_xsec2, "contour", "contour", 0 ) : 0 );
    TH2F* contour_em1s_xsec2    = ( hist5_xsec2!=0 ? FixAndSetBorders( *hist5_xsec2, "contour", "contour", 0 ) : 0 );
    TH2F* contour_ep1s_xsec4    = ( hist3_xsec4!=0 ? FixAndSetBorders( *hist3_xsec4, "contour", "contour", 0 ) : 0 );
    TH2F* contour_em1s_xsec4    = ( hist5_xsec4!=0 ? FixAndSetBorders( *hist5_xsec4, "contour", "contour", 0 ) : 0 );
    TH2F* contour_ep1s_xsec8    = ( hist3_xsec8!=0 ? FixAndSetBorders( *hist3_xsec8, "contour", "contour", 0 ) : 0 );
    TH2F* contour_em1s_xsec8    = ( hist5_xsec8!=0 ? FixAndSetBorders( *hist5_xsec8, "contour", "contour", 0 ) : 0 );
    ...
    if (showOneSigmaExpBand){
        ...
        TGraph* gr_contour_ep1s_xsec2;
        TGraph* gr_contour_em1s_xsec2;
        TGraph* gr_contour_ep1s_xsec4;
        TGraph* gr_contour_em1s_xsec4;
        TGraph* gr_contour_ep1s_xsec8;
        TGraph* gr_contour_em1s_xsec8;
        
        if(fxsec2){
            gr_contour_ep1s_xsec2 = (TGraph*) ContourGraph( contour_ep1s_xsec2 )->Clone(); 
            gr_contour_em1s_xsec2 = (TGraph*) ContourGraph( contour_em1s_xsec2 )->Clone(); 
        }
        if(fxsec4){
            gr_contour_ep1s_xsec4 = (TGraph*) ContourGraph( contour_ep1s_xsec4 )->Clone(); 
            gr_contour_em1s_xsec4 = (TGraph*) ContourGraph( contour_em1s_xsec4 )->Clone(); 
        }
        if(fxsec8){
            gr_contour_ep1s_xsec8 = (TGraph*) ContourGraph( contour_ep1s_xsec8 )->Clone(); 
            gr_contour_em1s_xsec8 = (TGraph*) ContourGraph( contour_em1s_xsec8 )->Clone(); 
        }
    }
    ...
    TH2F* contour_obscls_xsec2(0);
    if (histocls_xsec2!=0)     { contour_obscls_xsec2     = FixAndSetBorders( *histocls_xsec2, "contour_obscls_xsec2", "contour_obscls_xsec2", 0 ); }
    ...
    TH2F* contour_obscls_xsec4(0);
    if (histocls_xsec4!=0)     { contour_obscls_xsec4     = FixAndSetBorders( *histocls_xsec4, "contour_obscls_xsec4", "contour_obscls_xsec4", 0 ); }
    ...
    TH2F* contour_obscls_xsec8(0);
    if (histocls_xsec8!=0)     { contour_obscls_xsec8     = FixAndSetBorders( *histocls_xsec8, "contour_obscls_xsec8", "contour_obscls_xsec8", 0 ); }
    ...
    if (gridname.Contains("GG")) { 
        cout << "removing islands in GG ..." << endl;
        ...
        for (int xbin = 1; xbin <= contour_obs->GetNbinsX(); xbin++) {
            for (int ybin = 1; ybin <= contour_obs->GetNbinsY(); ybin++) {
                if ( ax->GetBinCenter(xbin) < 350.0 && 
                     ay->GetBinCenter(ybin) < 190.0){ 
                    contour_esigxsm1s->SetBinContent(xbin, ybin, 5.50);
                    contour_esigxsp1s->SetBinContent(xbin, ybin, 5.50);
                    contour_expcls->SetBinContent(xbin, ybin, 5.50);
                    contour_obs->SetBinContent(xbin, ybin, 5.50);
                    
                    contour_ep1s->SetBinContent(xbin, ybin, 5.50);
                    contour_em1s->SetBinContent(xbin, ybin, 5.50);
                    contour_esigxsp1s->SetBinContent(xbin, ybin, 5.50);
                    contour_esigxsm1s->SetBinContent(xbin, ybin, 5.50);
                    gr_contour_ep1s = (TGraph*) ContourGraph( contour_ep1s )->Clone();
                    gr_contour_em1s = (TGraph*) ContourGraph( contour_em1s )->Clone();
                    //gr_contour = (TGraph*) ContourGraph( contour )->Clone();
                }
            }
        }
    }
    
    if (gridname.Contains("SS")) { // electron

        //cout << "removing islands in SS ..." << endl;
        //// contour line is drawn for values at 1.64485
        //TAxis* ax = contour_obs->GetXaxis();
        //TAxis* ay = contour_obs->GetYaxis();
        ...
        //for (int xbin = 1; xbin <= contour_obs->GetNbinsX(); xbin++) {
            //for (int ybin = 1; ybin <= contour_obs->GetNbinsY(); ybin++) {
                //if ( ax->GetBinCenter(xbin) < 180.0 && ay->GetBinCenter(ybin) < 50.0){
                    //contour_ep1s->SetBinContent(xbin, ybin, 3.0);
                    //gr_contour_ep1s = (TGraph*) ContourGraph( contour_ep1s )->Clone();
                    
                    //contour_em1s->SetBinContent(xbin, ybin, 3.0);
                    //gr_contour_em1s = (TGraph*) ContourGraph( contour_em1s )->Clone();
        ...
        //if(contour_ep1s_xsec8){
            //TAxis* ax8 = contour_obs->GetXaxis();
            //TAxis* ay8 = contour_obs->GetYaxis();
            //for (int xbin = 1; xbin <= contour_ep1s_xsec8->GetNbinsX(); xbin++) {
                //for (int ybin = 1; ybin <= contour_ep1s_xsec8->GetNbinsY(); ybin++) {
                    //if ( ax8->GetBinCenter(xbin) < 150.0 && ay8->GetBinCenter(xbin) < 50.0){
                        //contour_ep1s_xsec8->SetBinContent(xbin, ybin, 5.5);
                        //gr_contour_ep1s_xsec8 = (TGraph*) ContourGraph( contour_ep1s_xsec8 )->Clone();
                    //}
                //}
            //}
    ...
    //if (gridname.Contains("SS")) { // electron
        ...
        //for (int xbin = 1; xbin <= contour_obs->GetNbinsX(); xbin++) {
            //for (int ybin = 1; ybin <= contour_obs->GetNbinsY(); ybin++) {
                ////if ( ax->GetBinCenter(xbin) > 500.0 && ax->GetBinCenter(xbin) < 545.0 &&
                     ////ay->GetBinCenter(ybin) > 190.0 && ay->GetBinCenter(ybin) < 210.0){
                    ////contour_esigxsm1s->SetBinContent(xbin, ybin, 1.50);
                ////}
                
                //if ( ax->GetBinCenter(xbin) > 475.0 && ax->GetBinCenter(xbin) < 545.0 &&
                     //ay->GetBinCenter(ybin) > 190.0 && ay->GetBinCenter(ybin) < 325.0){
                    //contour_esigxsm1s->SetBinContent(xbin, ybin, 0.0);
                //}
                
                //if ( ax->GetBinCenter(xbin) > 195.0 && ay->GetBinCenter(ybin) > 50.0 
                     //&& ax->GetBinCenter(xbin) < 365.0 && ay->GetBinCenter(ybin) < 250.0 
                     //&& ax->GetBinCenter(xbin) - ay->GetBinCenter(ybin) > 25.0)
                //) {
                    //cout << "Found spot here: " << xbin << " (" << ax->GetBinCenter( xbin)  << "), "
                        //<< ybin << " (" << ay->GetBinCenter( ybin) << "), "
                        //<< " value: " << contour->GetBinContent(xbin,ybin) <<   endl;
                    //cout << "   HACK : Setting above point by hand to 5.50 (!)" << endl;
                    
                    //contour->SetBinContent(xbin, ybin, 5.50);
                    //contour_obs->SetBinContent(xbin, ybin, 5.50);
                    //contour_ep1s->SetBinContent(xbin, ybin, 5.50);
                    //contour_em1s->SetBinContent(xbin, ybin, 5.50);
                    //contour_esigxsp1s->SetBinContent(xbin, ybin, 5.50);
                ...
                //// (437,212) island in expected limit
                //if ( ax->GetBinCenter(xbin) > 415.0 && ax->GetBinCenter(xbin) < 485.0 &&
                     //ay->GetBinCenter(ybin) > 200.0 && ay->GetBinCenter(ybin) < 260.0){
                    //cout << "HELLO" << endl;
                    //contour_ep1s->SetBinContent(xbin, ybin, 5.0);
                //}
    ...
    if(gridname.Contains("SS")){
        plotminx = 150;
    }
 
    TH2F *frame = new TH2F("frame", "m_{gluino} vs. m_{lsp} - ATLAS work in progress", 100, plotminx, plotrange, 100, plotminy, plotrangey );
    ...
    TLegend *leg = new TLegend(0.6,0.7,0.92,0.90);
    ...
    if (showOneSigmaExpBand){
        ...
        if(fxsec2){
            TGraph* grshadeExp_xsec2 = DrawExpectedBand( gr_contour_ep1s_xsec2, gr_contour_em1s_xsec2, CombinationGlob::c_DarkYellow , 1001 , 0)->Clone();
        }
        if(fxsec4){
            TGraph* grshadeExp_xsec4 = DrawExpectedBand( gr_contour_ep1s_xsec4, gr_contour_em1s_xsec4, CombinationGlob::c_DarkYellow , 1001 , 0)->Clone();
        }
        if(fxsec8){
            TGraph* grshadeExp_xsec8 = DrawExpectedBand( gr_contour_ep1s_xsec8, gr_contour_em1s_xsec8, CombinationGlob::c_DarkYellow , 1001 , 0)->Clone();
        }
    }
    ...
    TLegend *xsec8leg = 0;
    if (discexcl==1) {
        //xsecleg = new TLegend(800.0/1100.0, 350.0/750.0, 800.0/1100.0 + 0.180, 350.0/750.0 + 0.045);
        xsecleg = new TLegend(800.0/1100.0, 350.0/750.0, 800.0/1100.0 + 0.195, 350.0/750.0 + 0.045);

        if(gridname.Contains("SS") && !(fname0.Contains("N2") || fname0.Contains("N4") || fname0.Contains("N8")) ){
            xsecleg->SetTextSize( CombinationGlob::DescriptionTextSize );
            xsecleg->SetTextSize( 0.03 );
            xsecleg->SetTextFont( 42 );
            xsecleg->SetBorderSize(1);
            xsecleg->SetLineColor(14);
            xsecleg->SetFillColor( kWhite );
            xsecleg->SetFillStyle(1001);
            contour_obs->SetLineColor(c_myRed);contour_obs->SetLineWidth(2);
            //xsecleg->AddEntry(contour_obs, "#tilde{q}_{L} + #tilde{q}_{R} (#tilde{u}, #tilde{d}, #tilde{c}, #tilde{s})","L");
            //xsecleg->AddEntry(contour_obs, "1 non-degen. #tilde{q}","L");
            xsecleg->AddEntry(contour_obs, "8 degenerate #tilde{q}'s","L");
        }
        ...
        if (!extExpectation) { 
            ...
            if(contour_obscls_xsec2 !=0 ){
                DrawContourLine95( leg, contour_obscls_xsec2, "", c_myRed, 1, 4 );   // 95% CL_{S}
                if (contour_esigxsp1s_xsec2)
                    DrawContourLine95( leg, contour_esigxsp1s_xsec2, "", c_myRed, 3, 2 );    // Observed limit #pm 1 #sigma^{SUSY}_{theory}
                if (contour_esigxsm1s_xsec2)
                    DrawContourLine95( leg, contour_esigxsm1s_xsec2, "", c_myRed, 3, 2 );    // Observed limit #pm 1 #sigma^{SUSY}_{theory}
            }
            if(contour_obscls_xsec4 !=0 ){
                DrawContourLine95( leg, contour_obscls_xsec4, "", c_myRed, 1, 4 );   // 95% CL_{S}
                if (contour_esigxsp1s_xsec4)
                    DrawContourLine95( leg, contour_esigxsp1s_xsec4, "", c_myRed, 3, 2 );    // Observed limit #pm 1 #sigma^{SUSY}_{theory}
                if (contour_esigxsm1s_xsec4)
                    DrawContourLine95( leg, contour_esigxsm1s_xsec4, "", c_myRed, 3, 2 );    // Observed limit #pm 1 #sigma^{SUSY}_{theory}
            }
            
            if(contour_obscls_xsec8 !=0 ){
                xsec8leg = new TLegend(400.0/1100.0, 200.0/750.0, 400.0/1100.0 + 0.18, 200.0/750.0 + 0.045);

                xsec8leg->SetTextSize( CombinationGlob::DescriptionTextSize );
                xsec8leg->SetTextSize( 0.03 );
                xsec8leg->SetTextFont( 42 );
                xsec8leg->SetBorderSize(1);
                xsec8leg->SetLineColor(14);
                xsec8leg->SetFillColor( 0 );
                xsec8leg->SetFillStyle(1001);
                contour_obscls_xsec8->SetLineColor(c_myRed);contour_obscls_xsec8->SetLineWidth(2);
                //xsec8leg->AddEntry(contour_obscls_xsec8, "one light #tilde{q}","L");
                //xsec8leg->AddEntry(contour_obscls_xsec8, "8 degenerate #tilde{q}'s","L");
                xsec8leg->AddEntry(contour_obscls_xsec8, "1 non-degen. #tilde{q}","L");

                DrawContourLine95( leg, contour_obscls_xsec8, "", c_myRed, 1, 4 );   // 95% CL_{S}
                if (contour_esigxsp1s_xsec8)
                    DrawContourLine95( leg, contour_esigxsp1s_xsec8, "", c_myRed, 3, 2 );    // Observed limit #pm 1 #sigma^{SUSY}_{theory}
                if (contour_esigxsm1s_xsec8)
                    DrawContourLine95( leg, contour_esigxsm1s_xsec8, "", c_myRed, 3, 2 );    // Observed limit #pm 1 #sigma^{SUSY}_{theory}
            }

            if (contour_expcls_xsec2!=0) {
                DrawContourLine95( leg, contour_expcls_xsec2, "", CombinationGlob::c_DarkBlueT3, 6 );
            }
            if (contour_expcls_xsec4!=0) {
                DrawContourLine95( leg, contour_expcls_xsec4, "", CombinationGlob::c_DarkBlueT3, 6 );
            }
            if (contour_expcls_xsec8!=0) {
                DrawContourLine95( leg, contour_expcls_xsec8, "", CombinationGlob::c_DarkBlueT3, 6 );
            }
        ...
        // comment out the hepdata part if you want your plot to look OK

        //TString hepFile = "plots/SM_SS_direct_HepData.root";
        //if(fname0.Contains("SG")) {
            //hepFile = "plots/SM_SG_direct_HepData.root";
        //} else if(fname0.Contains("GG")) {
            //hepFile = "plots/SM_GG_direct_HepData.root";
        //}

        //TFile f(hepFile, "RECREATE");
        
        //TGraph* gcontour_expcls = ContourGraph( contour_expcls )->Clone(); 
        //gcontour_expcls->SetName("contour_expcls");
        //gcontour_expcls->SetTitle("Expected limit 95% CL"); 
        
        ////note: internally, our band seems reversed -> store it in OK format
        //TGraph* gcontour_em1s = gr_contour_ep1s->Clone();
        //gcontour_em1s->SetTitle("Expected limit 95% CL -1 sigma");
        //gcontour_em1s->SetName("contour_em1s");
        //TGraph* gcontour_ep1s = gr_contour_em1s->Clone();  
        //gcontour_ep1s->SetTitle("Expected limit 95% CL +1 sigma"); 
        //gcontour_ep1s->SetName("contour_ep1s");

        //f.cd(); 
        //gcontour_expcls->Write("gcontour_expcls");
        //gcontour_em1s->Write("gcontour_em1s");
        //gcontour_ep1s->Write("gcontour_ep1s"); 
        //c->cd();

        //TGraph* gcontour_om1s = ContourGraph( contour_esigxsm1s )->Clone(); 
        //TGraph* gcontour_op1s = ContourGraph( contour_esigxsp1s )->Clone();
        //TGraph* gcontour_obscls = ContourGraph( contour_obs )->Clone(); 
        ...
        //gcontour_om1s->SetName("contour_om1s");
        //gcontour_op1s->SetName("contour_op1s");
        //gcontour_obscls->SetName("contour_obscls");
    ...
    TLine *line=new TLine(plotminx,plotminx,xline,yline);
    ...
    if (show7TeV && gridname.Contains("GG")){
        graphGG1->Draw("LSAME");
        graphGG2->Draw("LSAME");
    ...
    if (show7TeV && gridname.Contains("SS")){
        graphSS1->Draw("LSAME");
        graphSS2->Draw("LSAME");
    ...
    if(showSR){
        ...
        Show_UL(fname0, c2, xmin, xmax, ymin, ymax, false, leg, xsecleg, xsec8leg);
       ...
       //Show_SR takes care of this normally, do it here if we don't print 
        ...
        TLine *line2;
        if (gridname.Contains("GG")) {
            line1 = new TLine( 992, 1412, 1079, 1412);
            line2 = new TLine( 992, 1355, 1079, 1355);
            cout << "GG line1" << endl;
            
        } else if (gridname.Contains("SS")) {
            // these coordinates match the old ones: the labels are at 534.0/900.0th of the plot - scale to new ones easily by changing numbers
            line1 = new TLine( (534.0/900.0)*(1100.0-150.0) + 150.0, 707, (596.0/900.0)*(1100.0-150.0) + 150.0, 707); 
            line2 = new TLine( (534.0/900.0)*(1100.0-150.0) + 150.0, 676, (596.0/900.0)*(1100.0-150.0) + 150.0, 676); 
            //line1 = new TLine( (534.0/900.0)*(1100.0-150.0) + 150.0, 658, (596.0/900.0)*(1100.0-150.0) + 150.0, 658); 
            //line2 = new TLine( (534.0/900.0)*(1100.0-150.0) + 150.0, 632, (596.0/900.0)*(1100.0-150.0) + 150.0, 632); 
            cout << "SS line1" << endl;
        } else if (gridname.Contains("SG")) {
    ...
    if(xsec8leg) xsec8leg->Draw();
    if(xsecleg) xsecleg->Draw();
...
void Show_SR(TString oredList,  TCanvas *can, float xlow, float xhigh, float ylow, float yhigh, bool useShape, TLegend *leg)
{
    ...
    TLine *line2;
    if (oredList.Contains("GG")) {
        line1 = new TLine( 992, 1412, 1078, 1412);
        line2 = new TLine( 992, 1355, 1078, 1355);
        //line1 = new TLine( 992, 1317, 1078, 1317);
        //line2 = new TLine( 992, 1264, 1078, 1264);
        cout << "GG line1" << endl;
...
void Show_UL(TString oredList, TCanvas *can, float xlow, float xhigh, 
        float ylow, float yhigh, bool acceff=false, TLegend *leg, TLegend *xsecleg, TLegend *xsec8leg) {
    Int_t c_myRed      = TColor::GetColor("#aa000");
    can->cd();
    ...
    tree->SetBranchAddress("m12", &m12, &b_m12);
    tree->SetBranchAddress("fID",  &fID,  &b_fID);
    tree->SetBranchAddress("upperLimit",  &UL,  &b_UL);
    ...
    TLatex *Leg0 = new TLatex( xhigh*1.0325, ylow*1.01, LegendTitle);
