...
TTree* harvesttree(const char* textfile=0) {
  const char* filename    = "/imports/rcs5_data/larryl/ZeroLeptonAnalysis/HistFitterSetup/ZeroLeptonFitter-00-01-11-branch/macros/contourplot/Outputs/13.3ifb_RJigsaw/SS_direct/SS_direct_SRJigsawSRG1a_fixSigXSecDown__1_harvest_list";
...
void writetree() {
  ...
  TFile* file = TFile::Open("/imports/rcs5_data/larryl/ZeroLeptonAnalysis/HistFitterSetup/ZeroLeptonFitter-00-01-11-branch/macros/contourplot/Outputs/13.3ifb_RJigsaw/SS_direct/SS_direct_SRJigsawSRG1a_fixSigXSecDown__1_harvest_list.root","RECREATE");
  file->cd();
  tree->Write();
  file->Close();
}
