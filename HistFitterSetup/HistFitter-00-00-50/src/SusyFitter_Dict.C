...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::__gnu_cxx::__normal_iterator<ChannelStyle*,vector<ChannelStyle> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("__gnu_cxx::__normal_iterator<ChannelStyle*,vector<ChannelStyle> >", "string", 708,
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooExpandedFitResult*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::XtraValues*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TMsgLogger*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::ChannelStyle*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TEasyFormula*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<ChannelStyle>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<ChannelStyle>", -2, "vector", 210,
...
"/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/root/6.02.12-x86_64-slc6-gcc48-opt/include",
"/imports/home/larryl/ZeroLeptonAnalysis/HistFitterSetup/HistFitter-00-00-50/src/",
0
    };
...
class __attribute__((annotate("$clingAutoload$LimitResult.h")))  JSON;
class __attribute__((annotate("$clingAutoload$LimitResult.h")))  JSONException;
...
"vector<ChannelStyle>", payloadCode, "@",
