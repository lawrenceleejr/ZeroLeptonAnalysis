#include "contourmacros/SUSY_mgl_vs_x_all_withBand_cls_blind_onestep_Compare.C"
	 
void makecontourplots_Compare_onestep_LSP60(const TString& combo1 = "all", const TString& combo2 = "all", bool useShape=false) 
{
 ...
 SUSY_mgl_vs_x_all_withBand_cls_blind_onestep_Compare(combo1, combo2,
   combo_XSup,
   combo_XSdown,
