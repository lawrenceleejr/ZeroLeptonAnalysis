...
//   TGraph* gr_contour_isr_down       = ContourGraph( hist_isrdown )->Clone();
  ...
  TH2F *frame ;
  frame = new TH2F("frame", "m_{0} vs m_{12} - ATLAS", 19, 725, 1420, 24, 225., 1200/*1200.*/ );
...
//  TColor::CreateGradientColorTable(Number,Length,Red,Green,Blue,nb);
 ...
 if(ymaxLine > ymax){
  ...
  //remove forbidden line in this grid TODO  
  ...
  TLatex gtt = TLatex(800,640,"#tilde{g}#rightarrow t#bar{t}#tilde{#chi}^{0}_{1} forbidden");
...
//// <------
  ...
  TLatex *Leg0 = new TLatex( xmin, ymax + dy*0.025, "#tilde{g}-#tilde{g} production, #tilde{g}#rightarrow t#bar{t}#tilde{#chi}^{0}_{1} (#tilde{t} on-shell)" );
...
if(showsig){
  ...
  TLatex clslimits = TLatex(/*755,503,au fost 533,475*/1150,1130,"All limits at 95% CL_{S}");
...
/*565 in loc de 578 si 591 -> 604*/
  TLine obsPOneSigma = TLine(770,926,818,926); //used to be 633/655; width should be 51, height diff with low 22
  obsPOneSigma.SetLineStyle(3);
  obsPOneSigma.SetLineWidth(2);
  obsPOneSigma.SetLineColor(c_myRed);
  obsPOneSigma.Draw("same");

  TLine obsMOneSigma = TLine(770,895,818,895);
