################################################################
##
## 2012 Meff vs Njet binned shape fit in the 0-lepton analysis
##
## Usage: HistFitter.py -p -t -w -d -f -r "2D,SR456" --exclfit -g "2400_400" analysis/ZeroLepton_example_2DBin2012_MeffNjet_highNjet.py
##
################################################################
...
### For Njet shape fit, choose the Njet range ###
# combine 2,3,4jet exSRs
uselowNjet=False 
# combine 4,5,6jet exSRs
usehighNjet=True
# combine 2,3,4,5,6jet exSRs if both uselowNjet and usehighNjet are false
...
maxbin=800000+minbin 

minbins=[1400000, 1200000, 1200000, 1000000, 900000]
...
meffcuts=[
    "(meffInc>"+str(minbins[0])+")",
    "(meffInc>"+str(minbins[1])+")",
    "(meffInc>"+str(minbins[2])+")",
    "(meffInc>"+str(minbins[3])+")",
    "(meffInc>"+str(minbins[4])+")"
    ]

meffloosecuts=[
    "(meffInc>"+str(minbins[0]-200000.)+")",
    "(meffInc>"+str(minbins[1]-200000.)+")",
    "(meffInc>"+str(minbins[2]-200000.)+")",
    "(meffInc>"+str(minbins[3]-200000.)+")",
    "(meffInc>"+str(minbins[4]-200000.)+")"
    ]
...
### For Njet shape fit, set the normalization of top component with CRT,W ###    
if uselowNjet:
    topSample.setNormRegions([("CRT2","meffInc"),("CRW2","meffInc"),("CRT3","meffInc"),("CRW3","meffInc"),("CRT4","meffInc"),("CRW4","meffInc")])
elif usehighNjet:
    topSample.setNormRegions([("CRT4","meffInc"),("CRW4","meffInc"),("CRT5","meffInc"),("CRW5","meffInc"),("CRT6","meffInc"),("CRW6","meffInc")])
else:
    topSample.setNormRegions([("CRT2","meffInc"),("CRW2","meffInc"),("CRT3","meffInc"),("CRW3","meffInc"),("CRT4","meffInc"),("CRW4","meffInc"),("CRT5","meffInc"),("CRW5","meffInc"),("CRT6","meffInc"),("CRW6","meffInc")])
...
if uselowNjet:
    qcdSample.setNormRegions([("CRQCD2","meffInc"),("CRQCD3","meffInc"),("CRQCD4","meffInc")])
elif usehighNjet:
    qcdSample.setNormRegions([("CRQCD4","meffInc"),("CRQCD5","meffInc"),("CRQCD6","meffInc")])
else:
    qcdSample.setNormRegions([("CRQCD2","meffInc"),("CRQCD3","meffInc"),("CRQCD4","meffInc"),("CRQCD5","meffInc"),("CRQCD6","meffInc")])
...
if uselowNjet:    
    wSample.setNormRegions([("CRT2","meffInc"),("CRW2","meffInc"),("CRT3","meffInc"),("CRW3","meffInc"),("CRT4","meffInc"),("CRW4","meffInc")])
elif usehighNjet:
    wSample.setNormRegions([("CRT4","meffInc"),("CRW4","meffInc"),("CRT5","meffInc"),("CRW5","meffInc"),("CRT6","meffInc"),("CRW6","meffInc")])
else:
    wSample.setNormRegions([("CRT2","meffInc"),("CRW2","meffInc"),("CRT3","meffInc"),("CRW3","meffInc"),("CRT4","meffInc"),("CRW4","meffInc"),("CRT5","meffInc"),("CRW5","meffInc"),("CRT6","meffInc"),("CRW6","meffInc")])
...
if uselowNjet:        
    gammaSample.setNormRegions([("CR1a2","meffInc"),("CR1a3","meffInc"),("CR1a4","meffInc")])
elif usehighNjet:        
    gammaSample.setNormRegions([("CR1a4","meffInc"),("CR1a5","meffInc"),("CR1a6","meffInc")])
else:
    gammaSample.setNormRegions([("CR1a2","meffInc"),("CR1a3","meffInc"),("CR1a4","meffInc"),("CR1a5","meffInc"),("CR1a6","meffInc")])
...
if uselowNjet:        
    zSample.setNormRegions([("CR1a2","meffInc"),("CR1a3","meffInc"),("CR1a4","meffInc")])
elif usehighNjet:        
    zSample.setNormRegions([("CR1a4","meffInc"),("CR1a5","meffInc"),("CR1a6","meffInc")])    
else:
    zSample.setNormRegions([("CR1a2","meffInc"),("CR1a3","meffInc"),("CR1a4","meffInc"),("CR1a5","meffInc"),("CR1a6","meffInc")])
...
configMgr.analysisName = "ZL_2DBin2012_MeffNjet_highNjet_"+anaName+"_"+grid+"_"+allpoints[0]
...
if uselowNjet:
    SRs=["SR2","SR3","SR4"]
    CR1as=["CR1a2","CR1a3","CR1a4"]
    CRQCDs=["CRQCD2","CRQCD3","CRQCD4"]
    CRTs=["CRT2","CRT3","CRT4"]
    CRWs=["CRW2","CRW3","CRW4"]
    VRQ1s=["VRQ12","VRQ13","VRQ14"]
    VRZs=["VRZ2","VRZ3","VRZ4"]
    VRT2Ls=["VRT2L2","VRT2L3","VRT2L4"]
    VRWT_Ps=["VRWT_P2","VRWT_P3","VRWT_P4"]
    VRWT_Ms=["VRWT_M2","VRWT_M3","VRWT_M4"]
    VRW1s=["VRW12","VRW13","VRW14"]
    VRT1s=["VRT12","VRT13","VRT14"]
    VRW2s=["VRW22","VRW23","VRW24"]
    VRT2s=["VRT22","VRT23","VRT24"]
    VRW3s=["VRW32","VRW33","VRW34"]
    VRT3s=["VRT32","VRT33","VRT34"]
    VRQCD2s=["VRQ22","VRQ23","VRQ24"]
elif usehighNjet:
    SRs=["SR4","SR5","SR6"]
    CR1as=["CR1a4","CR1a5","CR1a6"]
    CRQCDs=["CRQCD4","CRQCD5","CRQCD6"]
    CRTs=["CRT4","CRT5","CRT6"]
    CRWs=["CRW4","CRW5","CRW6"]
    VRQ1s=["VRQ14","VRQ15","VRQ16"]
    VRZs=["VRZ4","VRZ5","VRZ6"]
    VRT2Ls=["VRT2L4","VRT2L5","VRT2L6"]
    VRWT_Ps=["VRWT_P4","VRWT_P5","VRWT_P6"]
    VRWT_Ms=["VRWT_M4","VRWT_M5","VRWT_M6"]
    VRW1s=["VRW14","VRW15","VRW16"]
    VRT1s=["VRT14","VRT15","VRT16"]
    VRW2s=["VRW24","VRW25","VRW26"]
    VRT2s=["VRT24","VRT25","VRT26"]
    VRW3s=["VRW34","VRW35","VRW36"]
    VRT3s=["VRT34","VRT35","VRT36"]
    VRQCD2s=["VRQ24","VRQ25","VRQ26"]
...
for point in allpoints:
    ...
    for (iBin,cr1a) in enumerate(CR1as):
        iiBin=iBin
        if usehighNjet: iiBin=iBin+2
        ### For Meff shape fit ###
        CRGAMMA = myFitConfig.addChannel("meffInc",[cr1a],nbin,minbins[iiBin],maxbins[iiBin]) 
    ...
    for (iBin,sr) in enumerate(SRs):
        ...
        iiBin=iBin
        if usehighNjet: iiBin=iBin+2
        SR = myFitConfig.addChannel("meffInc",[sr],nbin,minbins[iiBin],maxbins[iiBin]) 
    ...
    if useQCD==True:
        for (iBin,crqcd) in enumerate(CRQCDs):
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            CRQCD = myFitConfig.addChannel("meffInc",[crqcd],nbin,minbins[iiBin],maxbins[iiBin]) 
    ...
    for (iBin,crt) in enumerate(CRTs):
        iiBin=iBin
        if usehighNjet: iiBin=iBin+2
        CRT = myFitConfig.addChannel("meffInc",[crt],nbin,minbins[iiBin],maxbins[iiBin]) 
    ...
    for (iBin,crw) in enumerate(CRWs):
        iiBin=iBin
        if usehighNjet: iiBin=iBin+2
        CRW = myFitConfig.addChannel("meffInc",[crw],nbin,minbins[iiBin],maxbins[iiBin]) 
    ...
    if doValidation:
        if not (len(pickedSRs)>=2 and pickedSRs[1].find("tight")>=0 and pickedSRs[0]=="SRD"): #no stat in SRD,tight
            for (iBin,vrz) in enumerate(VRZs):
                iiBin=iBin
                if usehighNjet: iiBin=iBin+2
                VRZ = myFitConfig.addChannel("meffInc",[vrz],nbin,minbins[iiBin],maxbins[iiBin]) 
        ...
        if len(pickedSRs)>=2 and pickedSRs[1].find("tight")<0:
            for (iBin,vrt2l) in enumerate(VRT2Ls):
                iiBin=iBin
                if usehighNjet: iiBin=iBin+2
                VRZ_1b = myFitConfig.addChannel("meffInc",[vrt2l],nbin,minbins[iiBin],maxbins[iiBin]) 
...
##         myFitConfig.setValidationChannels(VRZ_1c)
        ...
        for (iBin,vrwt_p) in enumerate(VRWT_Ps):
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            VRWT_P = myFitConfig.addChannel("meffInc",[vrwt_p],nbin,minbins[iiBin],maxbins[iiBin]) 
        ...
        for (iBin,vrwt_m) in enumerate(VRWT_Ms):
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            VRWT_M = myFitConfig.addChannel("meffInc",[vrwt_m],nbin,minbins[iiBin],maxbins[iiBin]) 
        ...
        for (iBin,vrw1) in enumerate(VRW1s):
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            VRW1 = myFitConfig.addChannel("meffInc",[vrw1],nbin,minbins[iiBin],maxbins[iiBin]) 
        ...
        for (iBin,vrt1) in enumerate(VRT1s):
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            VRT1 = myFitConfig.addChannel("meffInc",[vrt1],nbin,minbins[iiBin],maxbins[iiBin]) 
        ...
        for (iBin,vrw2) in enumerate(VRW2s):
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            VRW2 = myFitConfig.addChannel("meffInc",[vrw2],nbin,minbins[iiBin],maxbins[iiBin]) 
        ...
        for (iBin,vrt2) in enumerate(VRT2s):
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            VRT2 = myFitConfig.addChannel("meffInc",[vrt2],nbin,minbins[iiBin],maxbins[iiBin])
        ...
        for (iBin,vrw3) in enumerate(VRW3s): 
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            VRW3 = myFitConfig.addChannel("meffInc",[vrw3],nbin,minbins[iiBin],maxbins[iiBin]) 
        ...
        for (iBin,vrt3) in enumerate(VRT3s):
            iiBin=iBin
            if usehighNjet: iiBin=iBin+2
            VRT3 = myFitConfig.addChannel("meffInc",[vrt3],nbin,minbins[iiBin],maxbins[iiBin]) 
        ...
        if useQCD==True:
            for (iBin,vrqcd2) in enumerate(VRQCD2s):
                iiBin=iBin
                if usehighNjet: iiBin=iBin+2
                VRQCD2 = myFitConfig.addChannel("meffInc",[vrqcd2],nbin,minbins[iiBin],maxbins[iiBin]) 
            ...
            for (iBin,vrq1) in enumerate(VRQ1s):
                iiBin=iBin
                if usehighNjet: iiBin=iBin+2
                VRQCD1 = myFitConfig.addChannel("meffInc",[vrq1],nbin,minbins[iiBin],maxbins[iiBin])
