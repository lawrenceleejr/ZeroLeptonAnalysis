...
class OptimisationPlot:
    ...
    def findFiles(self):
        ...
        self.files = [f for f in getFileList(self.inputDir, cachefile=None, noWait=True) if f.endswith("json") and not "combined" in f]
        pass
    ...
    def write(self):
        ...
        for cut in self.contourData.filteredCombinedData:
            ...
            plt.xlabel('Grid point', position=(1,0), horizontalalignment='right', weight='bold')
