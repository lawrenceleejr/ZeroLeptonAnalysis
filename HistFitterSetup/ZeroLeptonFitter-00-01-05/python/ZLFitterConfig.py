...
class ZLFitterConfig:
    ...
    def __init__(self):
        ...
        self.flatErrorSignal=0.1  #this number is only used for the signal, see TheoUncertainties.py for the background
        ...
        self.luminosity = 1.7#unit is fb-1
        ...
        #LL# self.validationRegionsList += ["CRQ"]

        # #self.validationRegionsList+=["VRYf"]
        #LL# self.validationRegionsList += ["VRZ"]
        #LL# self.validationRegionsList +=["VRZf"]
        #LL# self.validationRegionsList+=["VRWf","VRTf"]
        #LL# self.validationRegionsList+=["VRWM","VRTM"]
        #LL# self.validationRegionsList+=["VRWMf","VRTMf"]
        ...
        #LL# self.validationRegionsList+=["VRQ1","VRQ2","VRQ3","VRQ4"] 
