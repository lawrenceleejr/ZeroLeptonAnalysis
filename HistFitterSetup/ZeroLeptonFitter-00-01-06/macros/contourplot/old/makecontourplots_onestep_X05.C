#include "contourmacros/SUSY_mgl_vs_mlsp_all_withBand_cls_blind_onestep.C"
	 
void makecontourplots_onestep_X05(const TString& combo = "all", bool useShape=false) 
{
 ...
 SUSY_mgl_vs_mlsp_all_withBand_cls_blind_onestep(combo,
   combo_XSup,
   combo_XSdown,
   "",
