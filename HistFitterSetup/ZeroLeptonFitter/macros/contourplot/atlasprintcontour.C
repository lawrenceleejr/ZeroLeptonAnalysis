...
void atlasprintcontour(const TString& combo = "all") 
{
  ...
  // 1leptonOR_smooth_list.root

  SUSY_m0_vs_m12_all_withBand("ZL2012_final_toy_msugra_combined_msugra_0_10_P_fixSigXSecNominal_merged_hypotest__1_harvest_list.root", ""/*"1lexp_list.root"*/, "1 lepton, 3+ jets",   35, showsignal, discexcl=1, showtevatron, showcms,  doOneSigmaBand, channel=2 );
...
void SUSY_m0_vs_m12_all_withBand( TString fname1 = "mudat_list.root",  // this is the expected limit
				...
				TString fnameMass= "mSugraGrid_gluinoSquarkMasses.root",
                   )
{
