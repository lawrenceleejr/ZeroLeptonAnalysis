...
///#include "contourmacros/0lep_Moriond_m0m12excl.C"
                                      ...
                                      TString fnameMass= "../../../HistFitterUser/common/mSugraGridtanbeta10_gluinoSquarkMasses.root")
{
   ...
   if(f1) histe_esigxsp1s = (TH2F*)f1->Get( hname0 ); 
   if(f2) histe_esigxsm1s = (TH2F*)f2->Get( hname0 ); 
  ...
  //TH2F *frame = new TH2F("frame", "m_{0} vs m_{12} - ATLAS for approval", 100, 100., 3500., 100, 300., 800. );
  TH2F *frame = new TH2F("frame", "m_{0} vs m_{12} - ATLAS for approval", 100, 200., 3500., 100, 300., 800. );
  ...
  TGraph* Moriond_obs = zl_Moriond_m0m12excl_obs();
  Moriond_obs->SetFillStyle(4001);
  c->cd();
  Moriond_obs->Draw("LSAME");
  Moriond_obs->Draw("FSAME");     
  ...
  //TLegend *leg = new TLegend(0.595,0.38,0.9,0.78);
  TLegend *leg = new TLegend(0.57,0.48,0.91,0.78);
...
//  DrawContourMassLine( histSquarkMass, 700.0 );
  DrawContourMassLine( histSquarkMass, 800.0 , ci_line_sub);
...
//  DrawContourMassLine( histSquarkMass, 1100.0 ); 
  DrawContourMassLine( histSquarkMass, 1200.0 , ci_line_sub);
...
//  DrawContourMassLine( histSquarkMass, 1500.0 );
  DrawContourMassLine( histSquarkMass, 1600.0 , ci_line_sub);
...
//  DrawContourMassLine( histSquarkMass, 1900.0 );
  DrawContourMassLine( histSquarkMass, 2000.0 , ci_line_sub);  
...
//  DrawContourMassLine( histSquarkMass, 2300.0 );     
  DrawContourMassLine( histSquarkMass, 2400.0 , ci_line_sub);
...
//  DrawContourMassLine( histSquarkMass, 2700.0 );
  DrawContourMassLine( histSquarkMass, 2800.0 , ci_line_sub);
...
//  DrawContourMassLine( histSquarkMass, 3100.0 ); 
  DrawContourMassLine( histSquarkMass, 3200.0 , ci_line_sub);  
//  DrawContourMassLine( histSquarkMass, 2300.0 );     
  DrawContourMassLine( histSquarkMass, 3400.0 );
//  DrawContourMassLine( histSquarkMass, 3500.0 );
  DrawContourMassLine( histSquarkMass, 3600.0 , ci_line_sub);
...
//  DrawContourMassLine( histSquarkMass, 4000.0 );        
  ...
  DrawContourMassLine( histGluinoMass, 500.0 , ci_line_sub);
  DrawContourMassLine( histGluinoMass, 600.0 );
  DrawContourMassLine( histGluinoMass, 700.0 , ci_line_sub);
  DrawContourMassLine( histGluinoMass, 800.0 );
  DrawContourMassLine( histGluinoMass, 900.0 , ci_line_sub);
  DrawContourMassLine( histGluinoMass, 1000.0 );  
  DrawContourMassLine( histGluinoMass, 1100.0 , ci_line_sub);  
  DrawContourMassLine( histGluinoMass, 1200.0 );  
  DrawContourMassLine( histGluinoMass, 1300.0 , ci_line_sub);      
  DrawContourMassLine( histGluinoMass, 1400.0 );
  DrawContourMassLine( histGluinoMass, 1500.0 , ci_line_sub);
  DrawContourMassLine( histGluinoMass, 1600.0 );
  DrawContourMassLine( histGluinoMass, 1700.0,  ci_line_sub );
  DrawContourMassLine( histGluinoMass, 1800.0 );
  DrawContourMassLine( histGluinoMass, 1900.0,  ci_line_sub );
  DrawContourMassLine( histGluinoMass, 2000.0 );  
  DrawContourMassLine( histGluinoMass, 2100.0, ci_line_sub ); 
...
*/
  ...
  s900->Draw();*/
  TLatex * s1000 = new TLatex( 555, 410, "#tilde{q} (1000 GeV)" );
  s1000->SetTextAlign( 11 );
  s1000->SetTextAngle(-61);
  s1000->SetTextSize( 0.025 );
  s1000->SetTextColor( kGray+1 );
  s1000->Draw(); 
  TLatex * s1400 = new TLatex( 1025, 490, "#tilde{q} (1400 GeV)" );
  //TLatex * s1400 = new TLatex( 1095, 440, "#tilde{q} (1400 GeV)" );
  s1400->SetTextAlign( 11 );
  s1400->SetTextAngle(-68);
  s1400->SetTextSize( 0.025 );
  s1400->SetTextColor( kGray+1 );
  s1400->Draw();   
  TLatex * s1800 = new TLatex( 1260, 670, "#tilde{q} (1800 GeV)" );
  //TLatex * s1800 = new TLatex( 1422, 572, "#tilde{q} (1800 GeV)" );
  s1800->SetTextAlign( 11 );
  s1800->SetTextAngle(-70);
  s1800->SetTextSize( 0.025 );
  s1800->SetTextColor( kGray+1 );
  s1800->Draw();   
  ...
  */
  ...
  g800->SetTextColor( kGray+1 );
  //g800->Draw();
  /// TLatex * g1000 = new TLatex( 1400, 399, "#tilde{g} (1000 GeV)" );
  TLatex * g1000 = new TLatex( 1235, 381, "#tilde{g} (1000 GeV)" );
  //TLatex * g1000 = new TLatex( 2550, 382, "#tilde{g} (1000 GeV)" );
  g1000->SetTextAlign( 11 );
  g1000->SetTextAngle(-5); 
  g1000->SetTextSize( 0.025 );
  g1000->SetTextColor( kGray+1 );
  g1000->Draw();
  //TLatex * g1200 = new TLatex( 1655, 487, "#tilde{g} (1200 GeV)" );
  TLatex * g1200 = new TLatex( 1600, 493, "#tilde{g} (1200 GeV)" );
  g1200->SetTextAlign( 11 );
  g1200->SetTextAngle(-6); 
  g1200->SetTextSize( 0.025 );
  g1200->SetTextColor( kGray+1 );
  g1200->Draw();  
  TLatex * g1400 = new TLatex( 1465, 589, "#tilde{g} (1400 GeV)" );
  //TLatex * g1400 = new TLatex( 1650, 583, "#tilde{g} (1400 GeV)" );
  //TLatex * g1400 = new TLatex( 1650, 982, "#tilde{g} (1400 GeV)" );
  g1400->SetTextAlign( 11 );
  g1400->SetTextAngle(-6); 
  g1400->SetTextSize( 0.025 );
  g1400->SetTextColor( kGray+1 );
  g1400->Draw();
  TLatex * g1600 = new TLatex( 1310, 690, "#tilde{g} (1600 GeV)" );
  //TLatex * g1600 = new TLatex( 1650, 680, "#tilde{g} (1600 GeV)" );
  //TLatex * g1600 = new TLatex( 1650, 982, "#tilde{g} (1600 GeV)" );
  g1600->SetTextAlign( 11 );
  g1600->SetTextAngle(-6); 
  g1600->SetTextSize( 0.025 );
  g1600->SetTextColor( kGray+1 );
  g1600->Draw();
  ...
  if (true) { 
     ...
     TAxis* ax = contour_em1s->GetXaxis();
     TAxis* ay = contour_em1s->GetYaxis();


     
     for (int xbin = 1; xbin <= contour_em1s->GetNbinsX(); xbin++) {
        for (int ybin = 1; ybin <= contour_em1s->GetNbinsY(); ybin++) {
           if ( (ax->GetBinCenter( xbin) > 0. && ax->GetBinCenter( xbin) < 1000. &&
                 ay->GetBinCenter( ybin) > 0. && ay->GetBinCenter( ybin) <= 300.)
                ||
                ( ay->GetBinCenter( ybin) <330 )
              ) {
              /*
                cout << "Found spot here: " << xbin << " (" << ax->GetBinCenter( xbin)  << "), "
                << ybin << " (" << ay->GetBinCenter( ybin) << "), "
                << " value: " << contour_em1s->GetBinContent(xbin,ybin) <<   endl;
                   cout << "   HACK : Setting above point by hand to 1.50 (!)" << endl;
              */
              contour_em1s->SetBinContent(xbin, ybin, 2.0);
           }
        }
     }
     ...
     for (int xbin = 1; xbin <= contour_expcls->GetNbinsX(); xbin++) {
        for (int ybin = 1; ybin <= contour_expcls->GetNbinsY(); ybin++) {
                ...
                ay->GetBinCenter( ybin) > 0. && ay->GetBinCenter( ybin) <= 300. )
           {
              cout << "Found spot here: " << xbin << " (" << ax->GetBinCenter( xbin)  << "), "
                   << ybin << " (" << ay->GetBinCenter( ybin) << "), "
                   << " value: " << contour_expcls->GetBinContent(xbin,ybin) <<   endl;
              cout << "   HACK : Setting above point by hand to 1.50 (!)" << endl;
              contour_expcls->SetBinContent(xbin, ybin, 2.0);
           }
           if( each_SR==false && ((ay->GetBinCenter( ybin) <350 && ax->GetBinCenter( xbin)>2900)||( ay->GetBinCenter( ybin) <360 && ax->GetBinCenter( xbin)>3100 )))  contour_expcls->SetBinContent(xbin, ybin, 2.0); 
        }
     }   
  }
  ...
  if (true) { 
     cout << "removing islands in electron channel ..." << endl;
     // contour line is drawn for values at 1.64485
     TAxis* ax = contour_obscls->GetXaxis();
     TAxis* ay = contour_obscls->GetYaxis();
     
     for (int xbin = 1; xbin <= contour_obscls->GetNbinsX(); xbin++) {
        for (int ybin = 1; ybin <= contour_obscls->GetNbinsY(); ybin++) {
           // island 2
           if( ax->GetBinCenter( xbin) > 0. && ax->GetBinCenter( xbin) < 500. &&
               ay->GetBinCenter( ybin) > 0. && ay->GetBinCenter( ybin) <= 350. )
           {
              cout << "Found spot here: " << xbin << " (" << ax->GetBinCenter( xbin)  << "), "
                   << ybin << " (" << ay->GetBinCenter( ybin) << "), "
                   << " value: " << contour_obscls->GetBinContent(xbin,ybin) <<   endl;
              cout << "   HACK : Setting above point by hand to 1.50 (!)" << endl;
              contour_obscls->SetBinContent(xbin, ybin, 2.0);
           }
           
           if( each_SR==false && ((ay->GetBinCenter( ybin) <350 && ax->GetBinCenter( xbin)>2900)||( ay->GetBinCenter( ybin) <360 && ax->GetBinCenter( xbin)>3100 ))) contour_obscls->SetBinContent(xbin, ybin, 2.0);
        }
     }
  }
  

    if (true && contour_esigxsm1s) { 
     cout << "removing islands in contour_esigxsm1s ..." << endl;
     // contour line is drawn for values at 1.64485
     TAxis* ax = contour_esigxsm1s->GetXaxis();
     TAxis* ay = contour_esigxsm1s->GetYaxis();
     
     for (int xbin = 1; xbin <= contour_esigxsm1s->GetNbinsX(); xbin++) {
        for (int ybin = 1; ybin <= contour_esigxsm1s->GetNbinsY(); ybin++) {
           // island 2
           if( ax->GetBinCenter( xbin) > 0. && ax->GetBinCenter( xbin) < 500. &&
                 ay->GetBinCenter( ybin) > 0. && ay->GetBinCenter( ybin) <= 350. )
           {
              cout << "Found spot here: " << xbin << " (" << ax->GetBinCenter( xbin)  << "), "
                   << ybin << " (" << ay->GetBinCenter( ybin) << "), "
                   << " value: " << contour_esigxsm1s->GetBinContent(xbin,ybin) <<   endl;
              cout << "   HACK : Setting above point by hand to 1.50 (!)" << endl;
              contour_esigxsm1s->SetBinContent(xbin, ybin, 2.0);
           }
           if( each_SR==false && ((ay->GetBinCenter( ybin) <350 && ax->GetBinCenter( xbin)>2900)||( ay->GetBinCenter( ybin) <350 && ax->GetBinCenter( xbin)>3100 ))) contour_esigxsm1s->SetBinContent(xbin, ybin, 2.0); 
        }
     }
    }

    if (true && contour_esigxsp1s) { 
     cout << "removing islands in contour_esigxsp1s ..." << endl;
     // contour line is drawn for values at 1.64485
     TAxis* ax = contour_esigxsp1s->GetXaxis();
     TAxis* ay = contour_esigxsp1s->GetYaxis();
     
     for (int xbin = 1; xbin <= contour_esigxsp1s->GetNbinsX(); xbin++) {
        for (int ybin = 1; ybin <= contour_esigxsp1s->GetNbinsY(); ybin++) {
           // island 2
           if(ax->GetBinCenter( xbin) > 0. && ax->GetBinCenter( xbin) < 500. &&
              ay->GetBinCenter( ybin) > 0. && ay->GetBinCenter( ybin) <= 350. )
           {
              cout << "Found spot here: " << xbin << " (" << ax->GetBinCenter( xbin)  << "), "
                   << ybin << " (" << ay->GetBinCenter( ybin) << "), "
                   << " value: " << contour_esigxsp1s->GetBinContent(xbin,ybin) <<   endl;
              cout << "   HACK : Setting above point by hand to 1.50 (!)" << endl;
              contour_esigxsp1s->SetBinContent(xbin, ybin, 2.0);
           }

           if( each_SR==false && ((ay->GetBinCenter( ybin) <350 && ax->GetBinCenter( xbin)>2900)||( ay->GetBinCenter( ybin) <330 && ax->GetBinCenter( xbin)>2800 ))) contour_expcls->SetBinContent(xbin, ybin, 2.0); 
        }
     }
  ...
  if (true) { 
     cout << "removing islands in electron channel ..." << endl;
     // contour line is drawn for values at 1.64485
     TAxis* ax = contour_ep1s->GetXaxis();
     TAxis* ay = contour_ep1s->GetYaxis();
     
     for (int xbin = 1; xbin <= contour_ep1s->GetNbinsX(); xbin++) {
        for (int ybin = 1; ybin <= contour_ep1s->GetNbinsY(); ybin++) {
           // island 2
           if (ax->GetBinCenter( xbin) > 0. && ax->GetBinCenter( xbin) < 1000. &&
                ay->GetBinCenter( ybin) > 0. && ay->GetBinCenter( ybin) <= 300.  )
           {
              cout << "Found spot here: " << xbin << " (" << ax->GetBinCenter( xbin)  << "), "
                   << ybin << " (" << ay->GetBinCenter( ybin) << "), "
                   << " value: " << contour_ep1s->GetBinContent(xbin,ybin) <<   endl;
              cout << "   HACK : Setting above point by hand to 1.50 (!)" << endl;
              contour_ep1s->SetBinContent(xbin, ybin, 2.0);
           }

           if( each_SR==false && ((ay->GetBinCenter( ybin) <350 && ax->GetBinCenter( xbin)>2900)||( ay->GetBinCenter( ybin) <360 && ax->GetBinCenter( xbin)>3100 ))) contour_ep1s->SetBinContent(xbin, ybin, 2.0); 
        }
     }
...
//contour_esigxsp1s
  if (true && contour_esigxsp1s) { 
     ...
     for (int xbin = 1; xbin <= contour_esigxsp1s->GetNbinsX(); xbin++) {
        for (int ybin = 1; ybin <= contour_esigxsp1s->GetNbinsY(); ybin++) {
           // island 2
           if( each_SR==false && ((ay->GetBinCenter( ybin) <350 && ax->GetBinCenter( xbin)>2900)||( ay->GetBinCenter( ybin) <360 && ax->GetBinCenter( xbin)>3100 ))) contour_esigxsp1s->SetBinContent(xbin, ybin, 2.0);
        }
     }
  }
  ...
  if (true && contour_esigxsm1s) { 
     ...
     for (int xbin = 1; xbin <= contour_esigxsm1s->GetNbinsX(); xbin++) {
        for (int ybin = 1; ybin <= contour_esigxsm1s->GetNbinsY(); ybin++) {
           // island 2
           if( each_SR==false && ((ay->GetBinCenter( ybin) <350 && ax->GetBinCenter( xbin)>2900)||( ay->GetBinCenter( ybin) <360 && ax->GetBinCenter( xbin)>3100 ))) contour_esigxsm1s->SetBinContent(xbin, ybin, 2.0);
        }
     }
  }

  Int_t c_myYellow   = TColor::GetColor("#ffe938"); 
  TGraph* grshadeExp = DrawExpectedBand( gr_contour_ep1s, gr_contour_em1s, c_myYellow , 1001   , 0)->Clone();
  ...
  if (discexcl==1) {
     ...
     if (!extExpectation) { // expectation from toys
        ...
        if (showOneSigmaExpBand) {
           //if (contour_ep1s!=0) DrawContourLine95( leg, contour_ep1s, "", c_myYellow, 1 );
           //if (contour_em1s!=0) DrawContourLine95( leg, contour_em1s, "", c_myYellow, 1 );
  ...
  TGraph *noRGE = new TGraph; // YU
  TGraph *tachyon = new TGraph; // YU
  TGraph* msugra_noEWSB=new TGraph;
  TGraph* msugra_stauLSP_curve=new TGraph;
  
  msugraThExcl("../../../HistFitterUser/common/msugra_status.txt", msugra_stauLSP_curve, noRGE, msugra_noEWSB, tachyon);
  
  //msugra_noEWSB_curve = msugra_noEWSB("../../../HistFitterUser/common/noEWSB.txt");
  c->cd();
  noRGE->SetFillColor( CombinationGlob::c_DarkBlueT5 ); //kAzure-4 );
  noRGE->Draw("FSAME");
  noRGE->Draw("LSAME"); 
  
  //TGraph * msugra_lepchrg= new TGraph;
  //msugra_lepchrg=msugra_lepchrg();
  //msugra_lepchrg->Draw("FSAME");
  //msugra_lepchrg->Draw("LSAME"); 
  
  //msugra_stauLSP_curve->Draw("FSAME");
  //msugra_stauLSP_curve->Draw("LSAME");

  //msugra_noEWSB->Print();
  msugra_noEWSB->SetFillColor( kGreen+2 ); //CombinationGlob::c_LightGreen );
  msugra_noEWSB->Draw("FSAME");
  msugra_noEWSB->Draw("LSAME");
  ...
  leg->AddEntry(Moriond_obs,"Observed limit (4.7 fb^{-1}, 7 TeV)","F" );
  //leg->AddEntry(Moriond_exp,"Exp. limit (4.7 fb^{-1}, 7 TeV)","l" );  
  
  //leg->AddEntry(Moriond_obs,"Observed limit (L^{int} = 4.7 fb^{-1},  #sqrt{s}=7 TeV)","l" );
  // leg->AddEntry(Moriond_exp,"Expected limit (L^{int} = 4.7 fb^{-1},  #sqrt{s}=7 TeV)","l" );
  ...
  if (showtevatron==1 && discexcl==1) {
     ...
     leg->AddEntry( noRGE, "Non-convergent RGE","F" ); //"LEP Chargino","F");
     //leg->AddEntry( noRGE, "LEP2 #tilde{#chi}^{#pm}_{1}","F");
  ...
  leg->AddEntry( msugra_noEWSB, "No EW-SB","F" );
  ...
  Leg1->SetTextColor( 1 );
  Leg1->DrawLatex(0.6,0.87, Form("#int L dt = %1.1f fb^{-1},  #sqrt{s}=8 TeV",lumi));  // 0.32,0.87
  Leg1->AppendPad();
  ...
  Leg2->SetTextFont(42);
  if (prefix!=0) { 
    Leg2->DrawLatex(0.6,0.81,prefix); // 0.15,0.81
    Leg2->AppendPad(); 
  }
  ...
  atlasLabel->DrawLatex(0.3,0.87, "ATLAS"); // 0.15,0.87
  ...
  TLine* line1  = new TLine( 2040, 670, 2277, 670);
  line1->SetLineWidth(2);
  line1->SetLineColor(CombinationGlob::c_DarkRed);
  line1->SetLineStyle(3);
  line1->Draw("SAME") ;
  TLine* line2  = new TLine( 2040, 697, 2277, 697);
  ...
  TString outfile = objstring->GetString().ReplaceAll(".root","").ReplaceAll("_hypotest__1_harvest_list","");

  delete arr;

  TString prefixsave = TString(prefix).ReplaceAll(" ","_")+Form("%dinvfb_",lumi);
  ...
  prel->SetTextFont( 42 );
  prel->SetTextColor( 1 );
  // temp prel->SetTextSize( 0.04 );
  prel->SetTextSize( 0.04 );  
  //prel->DrawLatex(0.415, 0.87, "for approval");   // 0.27,0.87
  prel->DrawLatex(0.415, 0.87, "Preliminary");   // 0.27,0.87
  prel->AppendPad();
...
ContourGraph( TH2F* hist)
{
   ...
   h->GetYaxis()->SetRangeUser(300,800);
   h->GetXaxis()->SetRangeUser(100,3500);
