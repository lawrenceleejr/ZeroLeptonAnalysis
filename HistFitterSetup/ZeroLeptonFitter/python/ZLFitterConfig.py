...
class ZLFitterConfig:
    ...
    def __init__(self):
        ...
        #blinding
        self.blindSR=False #True
        self.blindCR=False #True
        self.blindVR=False #True
        ...
        self.minbin      = 1000*1000
        self.maxbin      = 2000*1000
        self.nBins       = 5
        self.binVar      = "meffInc"
        ...
        self.luminosity = 0.080 #fb-1
        self.luminosityEr = 0.028
